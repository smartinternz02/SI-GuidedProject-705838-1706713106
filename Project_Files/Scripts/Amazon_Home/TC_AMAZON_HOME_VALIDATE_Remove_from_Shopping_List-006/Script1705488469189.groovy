...
WebUI.click(findTestObject('Object Repository/Amazon_OR/Page_The Da Vinci Code (Robert Langdon) Bro_e0923b/input_submit.add-to-registry.wishlist'))

WebUI.click(findTestObject('Object Repository/Amazon_OR/Page_The Da Vinci Code (Robert Langdon) Bro_e0923b/a_View Your List'))

WebUI.click(findTestObject('Object Repository/Amazon_OR/Page_Amazon.com/input_submit.deleteItem'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Amazon_OR/Page_Amazon.com/div_Deleted'), 0)
