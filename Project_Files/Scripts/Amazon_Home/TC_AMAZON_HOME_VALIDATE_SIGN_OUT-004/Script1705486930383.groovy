...
WebUI.mouseOver(findTestObject('Object Repository/Amazon_OR/Page_Manage your Profiles/span_Account  Lists'))

WebUI.click(findTestObject('Object Repository/Amazon_OR/Page_Your Account/span_Sign Out'))
