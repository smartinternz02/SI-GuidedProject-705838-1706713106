...
WebUI.click(findTestObject('Object Repository/Amazon_OR/Page_Amazon.com. Spend less. Smile more/select_All Departments        Arts  Crafts _135c92'))
...
WebUI.click(findTestObject('Object Repository/Amazon_OR/Page_Amazon.com  Da vinci code/i_Author_a-icon a-icon-checkbox'))

unchecked = WebUI.verifyElementNotChecked(findTestObject('Object Repository/Amazon_OR/Page_Amazon.com  Da vinci code/i_Author_a-icon a-icon-checkbox'), 
    0)

if (unchecked == true) {
    System.out.println('element not checked')

    WebUI.check(findTestObject('Object Repository/Amazon_OR/Page_Amazon.com  Da vinci code/i_Author_a-icon a-icon-checkbox'))
