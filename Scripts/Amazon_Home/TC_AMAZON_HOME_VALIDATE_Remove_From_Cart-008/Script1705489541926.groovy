...
WebUI.click(findTestObject('Object Repository/Amazon_OR/Page_Amazon.com Books/img_a-dynamic-image p13n-sc-dynamic-image p_302d0a'))

WebUI.click(findTestObject('Object Repository/Amazon_OR/Page_Amazon.com Books/input_submit.addToCart'))

WebUI.click(findTestObject('Object Repository/Amazon_OR/Page_Amazon.com Shopping Cart/div_Added to Cart'))
